...
CREATE POLICY "Proprietários podem inserir templates" 
ON public.templates_mensagens 
FOR INSERT 
WITH CHECK (
  EXISTS (
...
CREATE POLICY "Proprietários podem atualizar templates" 
ON public.templates_mensagens 
FOR UPDATE 
USING (
  EXISTS (
...
CREATE POLICY "Proprietários podem deletar templates" 
ON public.templates_mensagens 
FOR DELETE 
USING (
  EXISTS (
